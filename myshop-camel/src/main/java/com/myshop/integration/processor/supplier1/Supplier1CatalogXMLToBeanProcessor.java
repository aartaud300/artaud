...
public class Supplier1CatalogXMLToBeanProcessor implements Processor {

	private final Unmarshaller unmarshaller;
	
	public Supplier1CatalogXMLToBeanProcessor() {
		try {
	...
	private static class Items {
		...
		private List<Supplier1Item> items;

		public List<Supplier1Item> getItems() {
			return items;
		}

		public void setItems(List<Supplier1Item> items) {
			this.items = items;
		}
