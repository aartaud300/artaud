 ...
 */
//TODO 04: Add Spring's @ManagedResource annotation to enable instances of this class
//        to be registered as JMX MBeans

@ManagedResource
public class DiningEntry implements Lifecycle {
	...
	// TODO 05: Add Spring's @ManagedAttribute annotation
	@ManagedAttribute
	public int getDiningEntryCount() {
		return diningEntryCount;
	}

	// TODO 06: Add Spring's @ManagedAttribute annotation
	@ManagedAttribute
	...
	// ---------------------------------------
	// -- Spring Lifecycle interface methods
	// ---------------------------------------
	@Override
	public void start() {
		this.running = true;
	...
	@Override
	public void stop() {
		outputStream.print("\n\nReceived shutdown request, press any key to exit.\n");
		this.running = false;
	}
	...
	public void acceptDiningInput() throws IOException {
		...
		do {
			try {
				...
				// TODO 03: Submit the 'dining' object created above to the RewardNetwork service
				rewardNetwork.rewardAccountFor(dining); //changed 
			...
			} while (isRunning() && !enterDining.equalsIgnoreCase("y") && !enterDining.equalsIgnoreCase("n"));

		} while (isRunning() && enterDining.equalsIgnoreCase("y"));
