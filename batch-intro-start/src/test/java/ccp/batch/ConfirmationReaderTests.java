...
public class ConfirmationReaderTests {
	...
	public void processValidStringMessage() throws Exception {
		...
		// TODO 01: call confirmationReader.read() and assert that the
		// returned Confirmation's transactionId equals UU_ID
	}
	...
	public void processValidBytesMessage() throws Exception {
		...
		Confirmation confirmation = confirmationReader.read();
		assertEquals(UU_ID, confirmation.getTransactionId());
		// TODO 02: call confirmationReader.read() and assert that the
		// returned Confirmation's transactionId equals UU_ID
	}
	...
	public void processEmptyQueue() throws Exception {
		...
		// TODO 03: call confirmationReader.read() and assert that
	...
	public void processInvalidStringMessage() throws Exception {
		...
		// TODO 04: call confirmationReader.read() and fail the test if it didn't 
		// result in a ParseExceptionby adding (expected=ParseException.class) to @Test 
	}
	...
	public void processMapMessage() throws Exception {
		...
		confirmationReader.read();
		// TODO 05: call confirmationReader.read() and fail the test if it didn't 
		// result in a ParseExceptionby adding (expected=ParseException.class) to @Test
	}
