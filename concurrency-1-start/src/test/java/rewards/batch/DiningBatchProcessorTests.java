...
public class DiningBatchProcessorTests {
	...
	public void testProcessBatch() throws IOException {
		...
		// TODO 01: create a classpath resource for dining-input-small.csv
		Resource diningBatchCsvFile = null;

		// TODO 02: process the resource using the diningBatchProcessor object

		// TODO 03: uncomment to ensure that all batch records actually made it into the database
