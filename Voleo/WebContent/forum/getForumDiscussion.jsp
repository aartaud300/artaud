...
<img src="<s:url value="images/personal.png" />" width="20" height="20" alt="Mes discussions" />				
<a href="myDiscussions.action">Mes Discussions</a><br>			
				<br>
				<s:iterator value="viewForumDiscussion">
