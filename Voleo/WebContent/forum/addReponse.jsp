...
<script src='js/lightboxEasy/basic/js/basic.js' type='text/javascript'></script>
	...
	<body>
		...
		<form id="editForm" method="post" action="addReponse.action">	
		<input type="hidden" name="newsId" /> Titre: <input type="text"
			value="<s:property value="title" />" name="reponse.titre" /> 
			<textarea id="editedText" name="reponse.answer" style="width: 100%; height: 300px">
