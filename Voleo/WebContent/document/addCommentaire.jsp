...
<div id="contenu">
<div class="pres_titre">Mon espace Perso</div>
<h1>Ajout Commentaires</h1>

<form id="editForm" method="post" action="addCommentaire.action">
	 <textarea
	id="editedText" name="newCommentaire.textcommentaire" style="width: 100%; height: 300px">
