...
<html>
	...
	<body>
		...
		<div id="contenu">
			<div class="pres_titre">Mon espace Perso</div>
			<h1>Mes Documents en Pending</h1>

<img src="<s:url value="images/retour.gif" />" width="16" height="16" alt="retour" /><a href="index.action">Retour</a>
<br>			
<s:url id="image" action="listPendingModifications">
	<s:param name="docType" value="'IMAGE'" />
</s:url>
<s:url id="video" action="listPendingModifications">
	<s:param name="docType" value="'VIDEO'" />
</s:url>
<s:url id="rawfile" action="listPendingModifications">
	<s:param name="docType" value="'RAWFILE'" />
</s:url>

<s:url id="text" action="listPendingModifications">
	<s:param name="docType" value="'TEXT'" />
</s:url>
			
			
			<ul>
			<img src="<s:url value="images/backup.png"/>" width="52" height="52"/>
			<li>
