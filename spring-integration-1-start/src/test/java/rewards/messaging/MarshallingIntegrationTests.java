...
public class MarshallingIntegrationTests {
	...
	public void inboundDiningXml() throws Exception {
		...
		Message<?> receivedDiningMessage = dinings.receive();
		// TODO assert that the received message payload is a Dining 
		// with the attributes from dining-sample.xml
	}
	...
	public void outboundConfirmation() throws Exception {
		...
		// TODO assert that the received message payload is a String;
		// make assertions about the contents to inspect the xml
	}
